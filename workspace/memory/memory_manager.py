...
class SuperClaudeMemoryManager:
    ...
    def get_stakeholder_context(self, stakeholder_key: str, days: int = 90) -> Dict[str, Any]:
        ...
        cursor.execute("SELECT * FROM stakeholder_profiles WHERE stakeholder_key = ?", (stakeholder_key,))
        ...
        if profile_row:
            profile = {
                ...
                'preferred_personas': json.loads(profile_row['preferred_personas']) if profile_row['preferred_personas'] else [],
    ...
    def store_initiative(self, initiative: StrategicInitiative) -> None:
        ...
        """, (
            ...
            json.dumps(initiative.resource_allocation) if initiative.resource_allocation else None,
    ...
    def get_initiatives_by_status(self, status: str = None, assignee: str = None) -> List[Dict[str, Any]]:
    ...
    def get_initiative_context(self, initiative_key: str) -> Dict[str, Any]:
        ...
        cursor.execute("SELECT * FROM strategic_initiatives WHERE initiative_key = ?", (initiative_key,))
        row = cursor.fetchone()
    ...
    def get_memory_stats(self) -> Dict[str, Any]:
        ...
        tables = ['executive_sessions', 'strategic_initiatives', 'stakeholder_profiles', 
                 'platform_intelligence', 'budget_intelligence', 'strategic_decisions']
...
def main():
    ...
    parser.add_argument('action', choices=['stats', 'recall', 'cleanup', 'test'], 
