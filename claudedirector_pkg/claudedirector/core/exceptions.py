...
class AIDetectionError(ClaudeDirectorError):
    ...
    def __init__(self, message: str, detection_type: str = None, confidence: float = None, **kwargs):
        self.detection_type = detection_type
        self.confidence = confidence
        super().__init__(message, component="ai_detection", detection_type=detection_type, confidence=confidence, **kwargs)
